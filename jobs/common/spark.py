...
def get_spark(app_name="banking_bronze") -> SparkSession:
    ...
    # JDBC driver for pg catalog
    builder = builder.config(
        "spark.jars.packages",
        "org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.6.0,org.postgresql:postgresql:42.7.4,org.apache.hadoop:hadoop-aws:3.4.1,com.amazonaws:aws-java-sdk-bundle:1.12.780",
    )
